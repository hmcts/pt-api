...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.LINKS_MANAGE_LINKS;

@Component
@RequiredArgsConstructor
public class LinksManageLinks implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(LINKS_MANAGE_LINKS.getId(), this::submit)
