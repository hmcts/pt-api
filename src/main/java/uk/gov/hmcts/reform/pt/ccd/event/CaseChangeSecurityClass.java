...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.CASE_CHANGE_SECURITY_CLASS;

@Component
@RequiredArgsConstructor
public class CaseChangeSecurityClass implements CCDConfig<PTCase, State, UserRole> {
