...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.REFER_TO_LEGAL_OFFICER;

@Component
@RequiredArgsConstructor
public class ReferToLegalOfficer implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(REFER_TO_LEGAL_OFFICER.getId(), this::submit)
