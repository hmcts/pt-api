...
public class DocumentManagementRemove implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(DOCUMENT_MANAGEMENT_REMOVE.getId(), this::submit)
            .forStates(
                CASE_ISSUED,
                CASE_PROGRESSION,
                HEARING_READINESS,
            ...
            .showSummary()
            .name(DOCUMENT_MANAGEMENT_REMOVE.getName())
