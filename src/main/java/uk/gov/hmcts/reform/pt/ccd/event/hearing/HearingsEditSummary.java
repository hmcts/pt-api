...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.HEARINGS_EDIT_SUMMARY;

@Component
@RequiredArgsConstructor
public class HearingsEditSummary implements CCDConfig<PTCase, State, UserRole> {
