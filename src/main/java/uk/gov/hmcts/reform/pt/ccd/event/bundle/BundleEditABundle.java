...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.BUNDLE_EDIT_A_BUNDLE;

@Component
@RequiredArgsConstructor
public class BundleEditABundle implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(BUNDLE_EDIT_A_BUNDLE.getId(), this::submit)
