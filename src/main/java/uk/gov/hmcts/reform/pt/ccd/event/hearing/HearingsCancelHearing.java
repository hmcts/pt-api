...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.HEARINGS_CANCEL_HEARING;

@Component
@RequiredArgsConstructor
public class HearingsCancelHearing implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(HEARINGS_CANCEL_HEARING.getId(), this::submit)
            .forStateTransition(
