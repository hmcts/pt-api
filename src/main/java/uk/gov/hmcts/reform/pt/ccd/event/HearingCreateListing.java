...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.HEARING_CREATE_LISTING;

@Component
@RequiredArgsConstructor
public class HearingCreateListing implements CCDConfig<PTCase, State, UserRole> {
