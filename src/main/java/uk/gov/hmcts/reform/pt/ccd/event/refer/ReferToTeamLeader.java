...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.REFER_TO_TEAM_LEADER;

@Component
@RequiredArgsConstructor
public class ReferToTeamLeader implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(REFER_TO_TEAM_LEADER.getId(), this::submit)
