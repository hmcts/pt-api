...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.CASE_EDIT_LISTING_REQS;

@Component
@RequiredArgsConstructor
public class CaseEditListingReqs implements CCDConfig<PTCase, State, UserRole> {
