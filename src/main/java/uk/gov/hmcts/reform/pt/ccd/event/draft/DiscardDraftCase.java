...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.SYSTEM_DISCARD_DRAFT_CASE;

@Component
@RequiredArgsConstructor
public class DiscardDraftCase implements CCDConfig<PTCase, State, UserRole> {
    @Override
