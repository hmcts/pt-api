...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.RESET_PIN;

@Component
@RequiredArgsConstructor
public class ResetPin implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(RESET_PIN.getId(), this::submit)
