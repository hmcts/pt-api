...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.MANAGE_CONTACT_INFORMATION;

@Component
@RequiredArgsConstructor
public class ManageContactInformation implements CCDConfig<PTCase, State, UserRole> {
