...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.CASE_ADD_HEARING_OPTIONS;

@Component
@RequiredArgsConstructor
public class CaseAddHearingOptions implements CCDConfig<PTCase, State, UserRole> {

    @Override
    public void configureDecentralised(DecentralisedConfigBuilder<PTCase, State, UserRole> configBuilder) {
        configBuilder
            .decentralisedEvent(CASE_ADD_HEARING_OPTIONS.getId(), this::submit)
