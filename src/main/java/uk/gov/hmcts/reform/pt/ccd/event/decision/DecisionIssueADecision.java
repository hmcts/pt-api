package uk.gov.hmcts.reform.pt.ccd.event.decision;
...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.DECISION_ISSUE_A_DECISION;

@Component
@RequiredArgsConstructor
public class DecisionIssueADecision implements CCDConfig<PTCase, State, UserRole> {
