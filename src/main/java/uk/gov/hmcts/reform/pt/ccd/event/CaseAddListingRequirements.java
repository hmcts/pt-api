...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.CASE_ADD_LISTING_REQUIREMENTS;

@Component
@RequiredArgsConstructor
public class CaseAddListingRequirements implements CCDConfig<PTCase, State, UserRole> {
