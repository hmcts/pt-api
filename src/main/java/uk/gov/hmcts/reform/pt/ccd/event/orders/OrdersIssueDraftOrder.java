...
import static uk.gov.hmcts.reform.pt.ccd.event.EventId.ORDERS_ISSUE_DRAFT_ORDER;

@Component
@RequiredArgsConstructor
public class OrdersIssueDraftOrder implements CCDConfig<PTCase, State, UserRole> {
