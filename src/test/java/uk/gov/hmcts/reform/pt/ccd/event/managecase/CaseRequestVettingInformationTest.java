...
class CaseRequestVettingInformationTest extends BaseEventTest {

    private CaseRequestVettingInformation underTest;

    @BeforeEach
    void setUp() {
        underTest = new CaseRequestVettingInformation();
